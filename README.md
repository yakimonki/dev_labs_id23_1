...
| Kozharova     |       |      |      |      |
| Kozubov       |  сдано     |      |      |      |
| Kostenko      | сдано |сдано | (доработать изменение параметров столба, птицы летают со столб по параболе, улетают по синусойде не вертикально, диапазон (от 160 до 90)U(от 90 до 20))     |      |
| Kochetkov     |       |      |      |      |
| Kuznetsov     | сдано |	 	|	 	|
| Kundalyov    	| 	 	|	 	|	 	|
| Kurbanov    	| сдано	 	|	 	|	 	|
