...
| Vu Le Hoang   | сдано|      |      |      |
| Gatamov       | сдано |сдано | (переделать анимацию, внимательнее прочитать описание лабы)     |      |
| Gorelov       | сдано | 🔥сдано     |сдано |      |
| Gushchin      | сдано |      | (доработать полет астеройда, чтобы не пролетал сквозь планету)     |      |
| Zaitseva      |       |      |      |      |
| Kim           |       |      |      |      |
| Kozharova     |       |      |      |      |
| Kozubov       |  сдано     |      |      |      |
...
|  Spekhin      | сдано	| 🔥сдано	| (добавить возможность редактировать стадо + вымирание)	 	|
